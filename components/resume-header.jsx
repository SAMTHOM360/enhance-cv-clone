...
export default function ResumeHeader({ isActive, hidePhoto = false }) {
    const dispatch = useDispatch()
    const header = useSelector((state) => state.resume.header)
    ...
    const handleToggleUppercase = (value) => {
        dispatch(toggleUppercaseName({ value }))
    }

    const handleTogglePhotoStyle = (value) => {
